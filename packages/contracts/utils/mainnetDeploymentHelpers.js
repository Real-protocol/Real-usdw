  ...
  async connectCoreContractsMainnet(contracts, LQTYContracts, chainlinkProxyAddress) {
    ...
    await this.isOwnershipRenounced(contracts.borrowerOperations) ||
      await this.sendAndWaitForTransaction(contracts.borrowerOperations.setAddresses(
        contracts.troveManager.address,
        //0xfC40E07e2184D6D8103A84487058F5A0b45C5F07,
        contracts.activePool.address,
        //0xbB9e50CA209b755053408E8d372dCAD8Db10852A,
        contracts.defaultPool.address,
        //0x6aF84966bd81AD0e564A3b7bA29336d1164B4093,
        contracts.stabilityPool.address,
        //0xf6a989A0477462Cb68613752E4ac10d9a52D5eaA,
        contracts.gasPool.address,
        //0x2BFdeCCE4FF999f422BcbaEadF4b4CA9ABA1FaC1,
        contracts.collSurplusPool.address,
        //0xa43dC8439AA4FC98c28210b0d6b4852632158AE3,
        contracts.priceFeed.address,
        //0xFcd6eF87Ed532978715967fD174ee3fFDF1A5549,
        contracts.sortedTroves.address,
        //0x8ba760882971c096ffFe0Ac9D1023beC302CE714,
        contracts.lusdToken.address,
        //0xC32B96529afa688F7b07107100529EcFA7901Cb2,
        //0x99001370bC2763408B04507D61c962FcA5efC405,
        LQTYContracts.lqtyStaking.address,
        0xd52C0377D4422d0DF35eA17FDfe9f3fa83b85660,
	{gasPrice}
      ))*/
