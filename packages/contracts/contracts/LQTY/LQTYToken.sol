...
contract LQTYToken is CheckContract, ILQTYToken {
    ...
    string constant internal _NAME = "REALP";
    string constant internal _SYMBOL = "REALP";
    ...
    uint public constant ONE_YEAR_IN_SECONDS = 15768000;  //changes to 6 months
        ...
        public 
    {
        ...
        uint bountyEntitlement = _1_MILLION.mul(2); // Allocate 2 million for bounties/hackathons/grants
        _mint(_bountyAddress, bountyEntitlement);

        uint incentivesEntitlement = _1_MILLION.mul(2);// Allocate 2 million for communityincentives/listings/partnerships
        _mint(_bountyAddress, incentivesEntitlement); //add to address list
        ...
        uint _lpRewardsEntitlement = _1_MILLION.mul(6).div(3);  // Allocate 2.0 million for LP rewards
        lpRewardsEntitlement = _lpRewardsEntitlement;
        _mint(_lpRewardsAddress, _lpRewardsEntitlement);

        uint growthEntitlement = _1_MILLION.mul(31); //growthEntitlement
        _mint(_bountyAddress, growthEntitlement); //add to address list
