...
let silent = true;
const multisig = "0x42DdCb0f5717191A0af97D2E118776Cf2EdDd0A4";
const feemanager = "0xd52C0377D4422d0DF35eA17FDfe9f3fa83b85660";
const Bounty = "0xcCB00E9c8fAcBB4661ef09Bb4EB5D86fFD989663";
...
export const deployAndSetupContracts = async (
  ...
  const deployment: _LiquityDeploymentJSON = {
    ...
    version: "unknown",
    deploymentDate: /*new Date().getTime()*/ 1617611590000,//make your edits here
    bootstrapPeriod: 0,
    totalStabilityPoolLQTYReward: "0",
    liquidityMiningLQTYRewardRate: "0",
    _priceFeedIsTestnet: false,
    _uniTokenIsMock: false/*!wethAddress*/,
    _isDev,
