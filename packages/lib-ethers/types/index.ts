...
interface BorrowerOperationsTransactions {
  ...
  setAddresses(_troveManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _sortedTrovesAddress: string, _lusdTokenAddress: string, _lqtyStakingAddress: string, _treasury: string, _overrides?: Overrides): Promise<void>;
...
interface LockupContractFactoryCalls {
  NAME(_overrides?: CallOverrides): Promise<string>;
  SECONDS_IN_SIX_MONTHS(_overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
...
interface PriceFeedCalls {
  ...
  tellorpreviousresponse(_overrides?: CallOverrides): Promise<BigNumber>;
}

interface PriceFeedTransactions {
  changeTrellorCaller(tellorCallerAddress: string, _overrides?: Overrides): Promise<void>;
...
interface TroveManagerTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _lusdTokenAddress: string, _sortedTrovesAddress: string, _lqtyTokenAddress: string, _lqtyStakingAddress: string, _feemanager: string, _overrides?: Overrides): Promise<void>;
