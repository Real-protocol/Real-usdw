...
const factoryAddress = "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f";//uniswap rinkeby
//const factoryAddress = "0xFcEc44Adb7aeB7a464B0aB0a8F6077AFE36aA4D9";//for ethw mainnet

const hasFactory = (chainId: number) => [4, 10001].includes(chainId);
//const hasFactory = (chainId: number) => [8001].includes(chainId);
...
export const createUniswapV2Pair = async (
  ...
  log(`Creating Uniswap v2 WETH <=> USDW pair...`);
