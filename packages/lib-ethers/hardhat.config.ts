...
const oracleAddresses = {
  ...
  rinkeby: {
    ...
    tellor: "0xD0f1B85fAB3d3fF049a266Ec58BF4E5d75B5BeBe" // Core
  },
  ethpow: {
    chainlink: "0x8A753747A1Fa494EC906cE90E9f37563A8AF630e",
    tellor: "0x81Dd9cc325ECa58456EfC16575874fCB19D883dB" // Change to indexer core
  },
  kovan: {
...
const wethAddresses = {
  ...
  ethpow: "0xce7726e4175240F4289F953Ea6Ccf854e429f2C1"
};
...
const config: HardhatUserConfig = {
  networks: {
    ...
    mumbai: {
      url : "https://polygon-mumbai.g.alchemy.com/v2/bIm8cpbBxzSieDbuubuKBKa0huzQLKdd",
      accounts: [deployerAccount]
    },
    ethpow: {
      url : "https://polygon-mumbai.g.alchemy.com/v2/bIm8cpbBxzSieDbuubuKBKa0huzQLKdd",
...
task("deploy", "Deploys the contracts to the network")
  ...
  .setAction(
    async ({ channel, gasPrice, useRealPriceFeed, createUniswapPair }: DeployParams, env) => {
      ...
      useRealPriceFeed ??= env.network.name === "rinkeby";
