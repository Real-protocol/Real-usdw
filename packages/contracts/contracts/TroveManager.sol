...
contract TroveManager is LiquityBase, Ownable, CheckContract, ITroveManager {
    ...
    */
        ...
        override
    {
        ...
        uint oldfee = totals.ETHFee.div(2);
        uint newfee = totals.ETHFee.sub(oldfee);
        contractsCache.activePool.sendETH(address(contractsCache.lqtyStaking), newfee);
        contractsCache.activePool.sendETH(address(feemanager), oldfee);
